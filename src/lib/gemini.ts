...
Extract and create distinctive, story-tailored character profiles with LOCKED VISUAL CONSISTENCY PROFILES for this exact video idea.
...
- Analyze the video idea and extract the authentic characters directly requested or implied by the story (e.g. if the story is about an Indian boy finding a talking elephant in a jungle, generate Character 1: The Indian Boy (Human Boy, e.g. Golu/Aarav) and Character 2: The Talking Elephant (Fantasy Creature / Animal, e.g. Appu/Gajraj)).
- Assign an explicit "characterType" (e.g. "Human Boy", "Human Girl", "Animal", "Fantasy Creature", "Elder", "Lead Host", "Hero", etc.).
- Build a robust "characterIdentityLock" and "visualPromptAnchor" that locks their face, hair, skin, clothing, and accessories so any AI video model renders them 100% consistently across all scenes.

Generate a JSON array of character objects matching this exact structure:
[
  {
    "id": "char-1",
    "name": "Character Name (authentic to story & cultural setting)",
    "role": "Role (e.g. Protagonist / Magical Companion / Lead Guide)",
    "characterType": "Human Boy / Animal / Fantasy Creature / Host / etc.",
    "species": "Human / Asian Elephant / etc.",
    "age": "Age (e.g. 7 years old)",
    "gender": "Boy / Girl / Male / Female / Genderless",
    "appearance": "Comprehensive visual description combining face, build, skin, and presence in ${settings.visualStyle}",
    "face": "Detailed facial features: eye shape/color, nose, mouth, expressions",
    "hair": "Exact hairstyle, texture, cut, and color",
    "skinOrVisualCharacteristics": "Skin tone or texture/fur details",
    "bodyOrBuild": "Height, build, silhouette",
    "clothing": "Exact signature clothing outfit, fabrics, colors, footwear",
    "accessories": "Signature props, bell, necklace, bag, or items always carried",
    "personality": "Key personality traits",
    "personalityTraits": ["Trait 1", "Trait 2", "Trait 3"],
    "expressions": "Signature emotional reactions",
    ...
    "characterPurpose": "Strategic role in driving story engagement",
    "visualPromptAnchor": "Diffusion prompt anchor locking exact features for AI video generation",
    "characterIdentityLock": "Strict identity lock summary: [Name], [Type], [Age/Species], [Key Visuals], [Signature Clothing & Accessories]"
  }
]
