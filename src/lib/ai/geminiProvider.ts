...
export class GeminiProvider implements AIProvider {
  ...
  async generateStory(idea: string, settings: ProjectSettings, userStory?: string): Promise<StoryData> {
    return this.executeWithSanitization(() => generateStoryAI(idea, settings, userStory));
  }
