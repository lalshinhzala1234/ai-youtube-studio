...
export function extractAllAssetsUniversal(
  ...
  const STOP_PHRASES = new Set([
    ...
    'khul', 'khula', 'khola', 'khole', 'kholti', 'kholta', 'jalayi', 'jalaya', 'jalaye', 'jalata', 'jalati',
    'milta', 'milti', 'milte', 'mila', 'mili', 'mile', 'dakhil', 'hote', 'hota', 'hoti', 'khoj',
    'naksha', 'gufa', 'purana', 'purani', 'purane', 'naya', 'nayi', 'naye', 'chalti', 'chalta', 'chalte',
    'jata', 'jati', 'uthta', 'uthti', 'poora', 'poori', 'behnein', 'behen', 'bhai', 'dost', 'mitra', 'saath',
