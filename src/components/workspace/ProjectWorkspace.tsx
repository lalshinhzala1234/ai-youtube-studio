...
export const ProjectWorkspace: React.FC<ProjectWorkspaceProps> = ({
  ...
  const sidebarItems: { id: WorkspaceTab; label: string; icon: React.ReactNode; color: string }[] = [
    ...
    { id: 'props', label: 'Props', icon: <Package className="w-4 h-4" />, color: 'text-amber-400' },
    { id: 'environments', label: 'Environments', icon: <Compass className="w-4 h-4" />, color: 'text-emerald-400' },
    ...
    <div className="flex-1 flex h-screen overflow-hidden bg-[#090c10] relative">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden min-w-0">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-10 max-w-6xl mx-auto w-full">
          ...
          {activeTab === 'props' && (
            <PropsSection project={project} onUpdateProject={onUpdateProject} />
          )}
          {activeTab === 'environments' && (
            <EnvironmentsSection project={project} onUpdateProject={onUpdateProject} />
          )}
          {activeTab === 'scenes' && (
